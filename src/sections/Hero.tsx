      ...
      <Container className="grid gap-14 py-20 md:py-28 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10">
        <div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <Button as="a" href={profile.resumePdfPath} download variant="secondary">
              Download Resume
            </Button>
            <div className="ml-1 flex items-center gap-1">
              <Button as="a" href={profile.github} target="_blank" rel="noreferrer" variant="ghost" size="sm">
              ...
              <Button as="a" href={profile.linkedin} target="_blank" rel="noreferrer" variant="ghost" size="sm">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
